...
const getByUuidSchema = Joi.object({ uuid: Joi.string().required().error(commonService.getValidationMessage) }).error(
  commonService.getValidationMessage
);
...
const saveSchema = Joi.object({
  ...
  weight: Joi.number().allow(null).required().error(commonService.getValidationMessage),
  height: Joi.number().allow(null).required().error(commonService.getValidationMessage),
  status: Joi.string()
...
const getListSchema = Joi.object({
  ...
  moodFace: Joi.number().allow(null).error(commonService.getValidationMessage),
